...
For a real cohort BCF + MSP:

```{r phased-pipeline-real, eval=FALSE}
result <- run_phased_pipeline(
...
# result$african, result$european — dosage matrices (variants × samples)
# result$variant_info             — data.frame: chrom, pos, ref, alt
# result$vcf_paths                — african_ds.vcf, european_ds.vcf, *.gds
```
