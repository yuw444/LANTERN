...
**L**ocal **A**ncestry-**N**oted **T**ransmission **R**egion
**N**ucleotides
...
The pipeline automatically handles mismatches between GT and PT
matrices:
...
For heterozygous genotypes (gt=1) with mixed ancestry (pt=2), the
algorithm uses population-based proportions (p1, p2):
...
- **Singleton**: When all alt alleles come from mixed het individuals
  (N5 = sum(gt)), p1 = p2 = 0.5
