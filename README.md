...
To obtain the $p_1$ and $p_2$, we use the following formulas. $p_1 = \frac{(2*N_1 + N_2 + N_4)}{(2*N_1 + N_2 + 2*N_4 + 2*N_7 + N_8)}$ and $p_2 = (N_4 + 2*N_7 + N_8) / (2*N_1 + N_2 + 2*N_4 + 2*N_7 + N_8)$.
